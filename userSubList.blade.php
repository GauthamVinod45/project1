    ...
    <div class="container-fluid">
       ...
       <div class="row">
        <div class="col-lg-2 pl-0">
          ...
          <a href="{{route('userSubList')}}" class="active pt-3"><i class="fa fa-line-chart pl-4 pr-3" aria-hidden="true"></i>Joint list</a>
        ...
        <div class="topnav">
          ...
          <div class="topnav-left">
            <h5 class="pt-4 pl-4">User Subscription list</h5>
          </div>
...
//                       $("#userdata").append("<tr><td>"+id+"</td><td>"+name+"</td><td>"+mail+"</td><td>"+sid+"</td><td>"+sub+"</td></tr>");
