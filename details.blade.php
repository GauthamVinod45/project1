    ...
    <div class="container-fluid">
       ...
       <div class="row">
        <div class="col-lg-2 pl-0">
          ...
          <a href="{{route('details')}}" class="active pt-3"><i class="fa fa-home pl-4 pr-3" aria-hidden="true" style="font-size:21px;"></i> Dashboard</a>
          <a href="{{route('acc_details')}}"class="pt-3"><i class="fa fa-users pl-4 pr-3" aria-hidden="true"></i>Profile</a>
          </div>
        ...
        <div class="topnav">
          <div class="topnav-left">
            <h5 class="pt-4 pl-5">Dashboard</h5>
          </div>
        ...
        <div id="Home" class="pt-5 pb-4">
          <h3>Welcome to Open</h3>
        </div>
        <div class="row justify-content-center">
        <div class="col-lg-3 p-0 pl-4">
        <div class="card" onclick="window.location.href='http://127.0.0.1:8000/acc_details'">
          <div class="card-body">
            <i class="fa fa-users pt-4 pb-5" aria-hidden="true" style="font-size:50px;color:#639;"></i>
            <h5 class="card-title">Account Details</h5>
            <p class="card-text">View your account details</p>
          </div>
        </div>
        </div>
        <div class="col-lg-3 p-0 pl-4">
        <div class="card" onclick="window.location.href='http://127.0.0.1:8000/acc_details'">
          <div class="card-body">
            ...
            <p class="card-text">View your subscriptions</p>
          </div>
        </div>
        </div>
