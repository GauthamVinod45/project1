    ...
    <div class="container-fluid">
       ...
       <div class="row">
        <div class="col-lg-2 pl-0">
          ...
          <a href="{{route('mark_list')}}" class="active pt-3"><i class="fa fa-child pl-4 pr-3" aria-hidden="true" style="font-size:23px;"></i> Marks List</a>
          </div>
        ...
        <div class="topnav">
          ...
          <div class="topnav-left">
            <h5 class="pt-4 pl-4">Marks list</h5>
          </div>
                  ...
                  <tbody>
                     @foreach($data as $key => $value)
                      <tr>
                        ...
                        <td style="text-align:right;">{{$value->percentage}}</td>
                      </tr>
                      @endforeach
                  </tbody>
                </table>
...
$(document).ready( function () {
  ...
  //       language: {
  //   paginate: {
  //     next: '<i class="material-icons-round">arrow_back</i>',
  //     previous: '<i class="material-icons-round">arrow_back</i>', 
  //   }
  // }
    });
} );
